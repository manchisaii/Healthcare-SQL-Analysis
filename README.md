...
The goal is to use SQL to answer business-focused questions and uncover insights related to patient activity, hospital operations, treatment costs, and financial performance.
...
Uses advanced SQL techniques to analyze cumulative revenue, month-over-month revenue changes, revenue growth, patient revenue per appointment, revenue rankings, doctor revenue performance, treatment cost rankings, and monthly revenue performance.
...
├── screenshots/
│   ├── README.md
│   ├── advanced_cumulative_monthly_revenue.png
│   ├── advanced_monthly_revenue_change.png
│   ├── patient_high_utilization_high_revenue.png
│   └── hospital_doctor_cancellation_rate.png
└── sql/
